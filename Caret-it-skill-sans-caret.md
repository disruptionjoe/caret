<!-- This is the full prose version of the Caret-it skill, preserved for comparison.
     The active version is Caret-it-skill.md, which uses Caret^ notation for its own workflow. -->
